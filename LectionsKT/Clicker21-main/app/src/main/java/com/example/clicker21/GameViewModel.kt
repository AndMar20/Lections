...
class GameViewModel(app: Application): AndroidViewModel(app) {
        ...
        viewModelScope.launch {
            ...
            upgrades.map {
                when (it) {
                    ...
                    is OfflineEarningsUpgrade -> oflineCap = it.offlineCap
                }
            }
        }
    }
    ...
    var oflineCap by mutableStateOf(0)
    ...
    fun upgrade(item: Upgrade) {
        ...
        when (item) {
            ...
            is OfflineEarningsUpgrade -> oflineCap = item.offlineCap
        }
...
class ClickMultiplierUpgrade(
    ...
    override val description: String
        get() = "Множитель кликов ур.%d - x%.2".format(level, multiplier)
...
class OfflineEarningsUpgrade(
    ...
    override val description: String
        get() = "Лимин оффлайн дохода ур.$level - максимум $offlineCap к/с"
